...
<!--  content goes here -->
    <div class="col-sm-8 text-left"> 
      <h2 style="color:#1D1A9A">Add New Course</h2>
    
      <s:form action="saveCourse" cssClass="form-horizontal" namespace="/course" enctype="multipart/form-data" theme="bootstrap" id="addForm">
	...
	<s:textfield label="Duration (Hrs)" name="course.duration"></s:textfield>
