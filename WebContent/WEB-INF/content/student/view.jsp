...
<s:form action="saveStudent" cssClass="form-horizontal" namespace="/student" enctype="multipart/form-data" theme="bootstrap" id="addForm">
	<%-- <s:textfield label="Id" name="item.id"  ></s:textfield> --%>
	<s:textfield label="First Name" name="student.fname" readonly="true"></s:textfield>
	<s:textfield label="Last Name" name="student.lname" readonly="true"></s:textfield>
	<s:textfield label="Date Of Birth" name="student.dob" readonly="true"></s:textfield>
	<s:textfield label="Gender" name="student.gender" readonly="true"></s:textfield>
	<s:textfield label="NIC" name="student.nic" readonly="true"></s:textfield>
	<s:textfield label="Address" name="student.address" readonly="true"></s:textfield>
	<s:textfield label="School" name="student.school" readonly="true"></s:textfield>
	...
	<s:submit class="btn btn-primary btn-sm" formIds="addForm"/>
	<s:reset value="Cancel" class="btn btn-primary btn-sm" />
